...
const Drawer = ({ isOpen, onClose, title, children }) => {
  return (
    <>
      ...
      <div
        className={`fixed top-[64px] right-0 z-40 h-[calc(100dvh-64px)] custom-scrollbar p-4 overflow-y-auto bg-white w-full md:w-[40vw] shadow-2xl border-l border-gray-200 transition-transform duration-500 ease-in-out ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
        tabIndex="-1"
