                ...
                <div className='container mx-auto px-4 pt-6 pb-[200px] relative z-10'>
                    ...
                    <div className='flex flex-col md:flex-row items-center'>
                        <div className='w-full md:w-1/2 mb-8 md:mb-0 pr-4'>
                            <div className='flex items-end justify-left mb-2'>
                            ...
                            <h1 className='text-5xl font-mediuum mb-6 leading-tight text-black'>
            ...
            <div className='w-full min-h-full relative z-10'>
                <div>
                    <section className='flex items-center justify-center -mt-36'>
                        <img src={"/image.jpg"} alt="" className='w-[80vw] rounded-lg' />
                    </section>
                </div>
                            ...
                            <div className='flex flex-col items-center gap-8'>
                                <div className='grid grid-cols-1 md:grid-cols-3 gap-8 w-full'>
                                    {APP_FEATURES.slice(0, 3).map((feature) => (
                                        <div key={feature.id}
                                            className='bg-[#FFFEF8] p-6 rounded-xl shadow-sm hover:shadow-lg shadow-amber-100 transition border border-amber-100 duration-300'>
